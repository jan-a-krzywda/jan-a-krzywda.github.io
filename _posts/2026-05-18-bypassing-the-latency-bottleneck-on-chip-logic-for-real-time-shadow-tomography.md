...
<a class="github-badge" href="https://github.com/jan-a-krzywda/quantum-gym/tree/main/shadow_gym"><img src="{{ site.baseurl }}/assets/images/25231.png" alt="" class="github-logo" /> GitHub Repo</a>
...
<figure class="post-figure">
  <img src="{{ site.baseurl }}/assets/images/latency1.webp" alt="" loading="lazy" />
</figure>
...
<figure class="post-figure">
  <img src="{{ site.baseurl }}/assets/images/latency2.webp" alt="Hardware Topology: A 3-qubit cluster state implementation mapped onto the chip. The central data qubits (yellow, D1–D3) are each coupled to two dedicated &quot;dice&quot; ancilla qubits—one for controlling the X-basis (red, X1–X3) and one for the…" loading="lazy" />
